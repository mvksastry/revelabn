		...
		<div class="container-fluid px-4">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0">Home: Users - Edit</h1>
						</div><!-- /.col -->
						<div class="col-sm-6">
			...
			<section class="content">
				<div class="container-fluid">
					...
					<div class="row">
                      ...
                      <div class="card-body">
                        <form method="POST" action="{{ route('group-users.update', $user->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                          ...
                          name="name" id="name" value="{{ ucwords($user->name) }}" placeholder="First and Last Name">
                                                  @if($errors->has('name'))
                        ...
                        <div class="form-group">
                          <label for="exampleInputBorderWidth2">Current Roles</label>
                                                  Roles:[
                        ...
                        <div class="form-group">
                          <label for="exampleInputBorderWidth2">Current Permissions</label>
                          @foreach($permsUser as $pu)
                                                  {{ $pu->name }};
                                                  @endforeach
                        </div>
