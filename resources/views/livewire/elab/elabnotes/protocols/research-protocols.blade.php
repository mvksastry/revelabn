        ...
        <div class="content-wrapper">
          ...
          <div class="content-header">
            <div class="container-fluid">
              <div class="row mb-2">
                <div class="col-sm-6">
                  <h3 class="m-0">Home: SOP - Protocols</h3>
                </div><!-- /.col -->
                <div class="col-sm-6">
          ...
          <section id="top1" class="content">
            <div class="container-fluid">
                  ...
                  <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                      <div class="tab-content p-0">
                          ...
                          <div class="p-1">
                            <div class="table-responsive" id="revenue-chart2" style="position: relative;">
                              @if(count($protocols) > 0)
                                @include('livewire.elab.elabnotes.protocols.active-protocol-list')
                              @else                     
                        ...
                        <button wire:click="showProtocolEntryForm()" class="btn btn-primary rounded">New Protocol</button>
                      </div>
                    </div> <!-- /. card body end -->
                  </div>
                </section>
              ...
              <!-- Main row -->
                ...
                @if($viewNewSOPForm)
                    @include('livewire.elab.elabnotes.protocols.new-protocol-form')
                @endif
                <!-- /All Bottoms for show/hide based on status -->
            </div><!-- /.container-fluid -->
          </section>
