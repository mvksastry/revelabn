      ...
      <div class="content-wrapper px-2">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 mb-3">Home: New Reagents</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
                                  ...
                                  <tbody> 
                                    <tr>
                                      <td class="text-center" colspan="2">
                                        <button type="submit" wire:click="fineChems" class="btn btn-primary">Products</button>
                                      </td>
                                      <td class="text-center">
                                        <button type="submit" wire:click="samples" class="btn btn-primary">Samples</button>
                                      </td>
                                      <td class="text-center">
                                        <button type="submit" wire:click="reagents" class="btn btn-primary">Reagents</button>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
